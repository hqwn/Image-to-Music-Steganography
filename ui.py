...
with info:
    ...
    program where the primary goal is to make a project and have fun. The thememe of this project is some sort of 
    spyware, hence this. 
    ...
    First it formats the image to a 500x500 resolution and turns it into gray scale. 
